...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $phone = stroke_tags(trim($data["phone"] ?? '')); // wait, strip_tags not stroke_tags! Let's correct this.
    ...
    $recipient = "info@freshcutsmeat.ae";
    $subject = "New Meat Supply Inquiry from $name";
